...
/* route: /admin/new_quiz
*/

helper.createQuiz = async (req, res, next) => {
    var newQuiz={
        quizID: req.body.quizCode,
        name: req.body.quizName,
        topic:req.body.Topic,
        alwaysVisible:false,
        resultDisplay:true,
        rules: req.body.Rules,
        questionCount: parseInt(req.body.qcnt),
        quizSetter: req.body.setterName,
        startTime: 0,
        endTime: 0,
    ...
    var temp=req.body.visiblity;
    if(temp==="Yes"){
        newQuiz.alwaysVisible=true;
        
    }
    else{
        newQuiz.alwaysVisible=false;
        newQuiz.startTime = req.body.startDate + " " + req.body.startTime;
        newQuiz.endTime = req.body.endDate + " "+ req.body.endTime;
    }

    temp =req.body.results_visiblity;
    if(!(temp==="Yes")){
        newQuiz.resultDisplay=false;
    }
    
   // res.redirect("/admin/new_quiz");

    var flag_contest = 0;
    await quiz.findOne({"quizID": newQuiz.quizID})
        .then((data) => {
        ...
        if(flag_contest == 0){
            ...
            for(var i = 0; i < newQuiz.questionCount;i++){
                var question={
                    Name : "",
                    Options:[],
                    Correct:"",
                ...
                var qno = i+1;
                eval('question.Name'+'= '+'req.body.Quest_'+qno+';');
                eval('question.Options[0]'+'= '+'req.body.Quest_'+qno+'_'+'1'+';');
                eval('question.Options[1]'+'= '+'req.body.Quest_'+qno+'_'+'2'+';');
                eval('question.Options[2]'+'= '+'req.body.Quest_'+qno+'_'+'3'+';');
                eval('question.Options[3]'+'= '+'req.body.Quest_'+qno+'_'+'4'+';');
                eval('question.Correct'+'= '+'req.body.Ans'+qno);
